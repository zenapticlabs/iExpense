      ...
      <Controller
        ...
        render={({ field: { onChange, onBlur, value } }) => {
          if (
            ...
            return (
              <TextInput
                ...
                style={{ lineHeight: 18, minHeight: field.multiline ? 80 : undefined }}
                onBlur={onBlur}
          ...
          if (field.type === "date") {
            ...
            const [defaultDate, setDefaultDate] = useState(dayjs(value || new Date()));
            ...
            return (
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <View>
                  ...
                  {showDatePicker && (
                    <DefaultModal isVisible={showDatePicker} onClose={handleClose}>
                      <View className="bg-white rounded-lg p-4" style={{ minHeight: 250 }}>
                        <DateCalendar
